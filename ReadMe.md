This is a clone of Apple's landing page, made using just HTML, and CSS (using flexbox and grids). The site also contains a responsive image-slideshow, made using the keyframes function.
